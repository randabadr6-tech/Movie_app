...
class _ContinueWatchingScreenState extends State<ContinueWatchingScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      context.read<MovieProvider>().fetchWatching(); 
    });
  }
          ...
          IconButton(
            ...
            onPressed: () {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(
                  content: Text('🔄 Refreshing continue watching...'),
            ...
            return Center(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'No movies to continue watching',
                    style: TextStyle(
                      fontSize: 22,
                  ...
                  Text(
                    'Watch movies from the home page to continue',
                    textAlign: TextAlign.center,
                    style: TextStyle(
                      fontSize: 14,
          ...
          return Column(
            children: [
              Container(
                ...
                child: Text(
                  '${provider.watching.length} movies', 
                  style: TextStyle(
                    fontSize: 14,
                    color: Colors.grey.shade400,
                  ),
              ...
              Expanded(
                child: GridView.builder(
                  ...
                  itemCount: provider.watching.length, 
                  itemBuilder: (context, index) {
                    final movie = provider.watching[index]; 
