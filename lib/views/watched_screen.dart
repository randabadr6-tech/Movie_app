...
class _WatchedScreenState extends State<WatchedScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      context.read<MovieProvider>().fetchWatched();
    });
  }
          ...
          IconButton(
            ...
            onPressed: () {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(
                  content: Text('🔄 Refreshing watched...'),
            ...
            return Center(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Mark movies as watched from the home page',
                    textAlign: TextAlign.center,
                    style: TextStyle(
                      fontSize: 14,
          ...
          return Column(
            children: [
              Container(
                ...
                child: Text(
                  '${provider.watched.length} movies watched',
                  style: TextStyle(
                    fontSize: 14,
                    color: Colors.grey.shade400,
                  ),
              ...
              Expanded(
                child: GridView.builder(
                  ...
                  itemCount: provider.watched.length,
                  itemBuilder: (context, index) {
                    final movie = provider.watched[index];
